...
export default function NewRaffle() {
  ...
  async function storeRaffle() {
    ...
    if (client_name === "") {
      showToast("Insira um nome do Cliente", "warning", "Atenção");
      return false;
    }
    if (client_cpf === "") {
      showToast("Insira um CPF do Cliente", "warning", "Atenção");
      return false;
    }
    if (client_phone === "") {
      showToast("Insira um Telefone do Cliente", "warning", "Atenção");
      return false;
    }
    if (client_email === "") {
      showToast("Insira um Email do Cliente", "warning", "Atenção");
      return false;
    }
    if (description === "") {
